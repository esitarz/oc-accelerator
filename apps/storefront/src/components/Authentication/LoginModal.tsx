  ...
  return (
    ...
    >
      ...
      <ModalContent bgColor="transparent">
        ...
        <ModalBody as={VStack} justifyContent="center">
          <Card
            display="grid"
            gridTemplateColumns={
          ...
          >
            <VStack alignItems="flex-start">
              <DEFAULT_BRAND p={0} w="75%" h="auto" />
              <Heading as="h1" size="2xl" color="chakra-subtle-text">
                {getHeadingText()}
              </Heading>
              <Text fontSize="sm">{getDescriptionText()}</Text>
            </VStack>
            {setForm()}
          </Card>
          <ButtonGroup justifyContent="center" w="container.md" gap={1}>
            <Button
              variant="link"
              color="white"
              size="xs"
              ...
              onClick={() => {
                setShowForgotPassword(
                  showForgotUsername ? false : !showForgotPassword
                );
